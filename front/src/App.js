...
function App() {
  ...
  return (
   ...
   <Routes>
    ...
    <Route path='/demo' element={<>{isMobile ? <NavMobileEcooter red={red} setRed={setRed} demo={demo} setDemo={setDemo} isMobile={isMobile} landing={false}/> : <NavbarEcooter red={red} setRed={setRed} demo={demo} setDemo={setDemo} isMobile={isMobile} landing={false}/>} <LandingEcooter red={red} setRed={setRed} demo={demo} setDemo={setDemo} isMobile={isMobile} /> <Demo demoRoute = {true} setDemo={setDemo} demo={demo}/> <Red setRed={setRed} red={red}/> <Footer demo={demo} setDemo={setDemo} color={"#6EC1E4"}/></>}/>

    <Route path='/red' element={<>{isMobile ? <NavMobileEcooter red={red} setRed={setRed} demo={demo} setDemo={setDemo} isMobile={isMobile} landing={false}/> : <NavbarEcooter red={red} setRed={setRed} demo={demo} setDemo={setDemo} isMobile={isMobile} landing={false}/>} <LandingEcooter red={red} setRed={setRed} demo={demo} setDemo={setDemo} isMobile={isMobile} /> <Demo demoRoute = {false} setDemo={setDemo} demo={demo}/> <Red redRoute={true} setRed={setRed} red={red}/> <Footer demo={demo} setDemo={setDemo} color={"#6EC1E4"}/></>}/>
   </Routes>
   </>
  );
}
